...
function tree_click_swan(e,treeId, treeNode) {
    ...
    $('#config-swan-svg1').attr('src',$('#config-swan-svg1').attr('src'));
    $('#config-swan-svg2').attr('src',$('#config-swan-svg2').attr('src'));
    ...
    methods: {
        ...
        copyurl:function () {
            ...
            if(nodes == null) {
                ...
                var clipBoardContent="http://localhost:18080/swan-admin/statics/gojs/samples/showres.html?id=" + nodes[0].id + "&name="+nodes[0].name;
