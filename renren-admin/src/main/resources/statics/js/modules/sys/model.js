function init() {
    ...
    var list=[{"id":"a","name":"a","parent_id":0,"icon":"F M244.414,133.231 L180.857,133.231 178.509,156.191 250.527,192.94z\
        ...
        {"id":"b","name":"b","parent_id":1,"icon":"F M190.761,109.999c-3.576-9.132-8.076-22.535,7.609-37.755c0.646,13.375,14.067,13.99,11.351,36.794\
    ...
    xhr.open("get","../../sys/sifanyclass/select",true);
    xhr.send();
