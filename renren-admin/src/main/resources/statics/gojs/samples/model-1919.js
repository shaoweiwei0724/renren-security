...
function init() {
    ...
    for(var i=0;i< str.classLists.length;i++){
       html+='<div style=" width: 200px">\n' +
           '                <div onclick="setTab(\''+(i+1)+'\')"  style="float: top; cursor: pointer;z-index: 99; width: 200px;">\n' +
           '                    <input id="model'+(i+1)+'"  style="background-color: #1E90FF; cursor: pointer; font-size: large; width:70%; height:40px;margin-left:30px; border:0px; color:#fff"  value="'+str.classLists[i].name+'"/>\n' +
           '                    <img id="pic'+(i+1)+'" style=" width:10%;  float: left; margin-top:10px;"    src="images/back.png"/>\n' +
           ...
           '                    <div style="width: 200px; height:10px ;border:0px; "></div>\n' +
           '                </div>\n' +
           '                <center>\n' +
    ...
    //  //定义第一个类的设备
    //  if(list[i].parentId==19)
    //  {
    //
    //      m1[x1]={"icon":list[i].id, "iconWidth":30, "iconHeight":60,  "text":list[i].name, "source":list[i]};
    //      x1+=1;
    //  }
    //  else if(list[i].parentId==20)
    //  {
    //      m2[x2]={"icon":list[i].id, "iconWidth":30, "iconHeight":60,  "text":list[i].name, "source":list[i]};
    //      x2+=1;
    //  }
    //  else if(list[i].parentId==21)
    //  {
    //      m3[x3]={"icon":list[i].id, "iconWidth":30, "iconHeight":60,  "text":list[i].name, "source":list[i]};
    //      x3+=1;
    //  }
    //  else if(list[i].parentId==22)
    //  {
    //      m4[x4]={"icon":list[i].id, "iconWidth":30, "iconHeight":60,  "text":list[i].name, "source":list[i]};
    //      x4+=1;
    //  }
    //  else
    //  {
    //      m5[y]={"icon":list[i].id, "iconWidth":30, "iconHeight":60,  "text":list[i].name,  "source":list[i]};
    //      y+=1;
    //  }
    // }
    // console.log(icon);
    ...
    function geoFunc(geoname) {
        ...
        // $.ajax({
        //     type:'get',
        //     url:"http://172.72.101.114:8080/renren-admin/sys/sifanydataimage/image/17",//这里是url
        //     success:function(body){
        //         console.log(body);  //body就是内容了，也就是url网页中的内容
        //     }
        // });
        // return "http://172.72.101.114:8080/renren-admin/sys/sifanydataimage/image/19.svg";
        return "http://172.72.101.114:8080/renren-admin/sys/sifanydataimage/image/19.svg";
    }
    ...
    //                         { toArrow: "Standard", stroke: null })
    //                 ),
    //             model: new go.GraphLinksModel(m3)
    //         });
    //         myPalette3 =
    //             $(go.Palette, "myPaletteDiv3",  // must name or refer to the DIV HTML element
    //                 {
    //                     maxSelectionCount: 1,
    //                     nodeTemplateMap: myDiagram.nodeTemplateMap,  // share the templates used by myDiagram
    //                     linkTemplate: // simplify the link template, just in this Palette
    ...
    //                                 { toArrow: "Standard", stroke: null })
    //                         ),
    //                     model: new go.GraphLinksModel(m4)
    //                 });
    //         myPalette4 =
    //             $(go.Palette, "myPaletteDiv4",  // must name or refer to the DIV HTML element
    //                 {
    //                     maxSelectionCount: 1,
    //                     nodeTemplateMap: myDiagram.nodeTemplateMap,  // share the templates used by myDiagram
    //                     linkTemplate: // simplify the link template, just in this Palette
    ...
    //                                 { toArrow: "Standard", stroke: null })
    //                         ),
    //                     model: new go.GraphLinksModel(m5)
    //                 });
    //
