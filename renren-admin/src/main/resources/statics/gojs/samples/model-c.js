function init() {
    ...
    var list=[{"id":0,"name":"a","parent_id":0,"icon":"F M244.414,133.231 L180.857,133.231 178.509,156.191 250.527,192.94z\
        ...
        {"id":1,"name":"b","parent_id":1,"icon":"F M190.761,109.999c-3.576-9.132-8.076-22.535,7.609-37.755c0.646,13.375,14.067,13.99,11.351,36.794\
    ...
    for(var i=0;i<list.length;i++)
    {
     ...
     {
         m1[x]={"icon":list[i].id, "iconWidth":30, "iconHeight":60, "portHeight":20, "text":list[i].name};
         x+=1;
     }
     else
     {
         m2[y]={"icon":list[i].id, "iconWidth":30, "iconHeight":60, "portHeight":20, "text":list[i].name};
         y+=1;
     }
