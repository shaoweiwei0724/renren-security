...
function init() {
    ...
    for(var i=0;i< str.classLists.length;i++){
       html+='<div style=" width: 200px">\n' +
           ...
           '                    <input id="model'+(i+1)+'"  style=" background-color: #1E90FF;cursor: pointer; font-size: large; width:70%; height:40px;margin-left:30px; border:0px; color:#EBEBEB"  value="'+str.classLists[i].name+'"/>\n' +
