...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/sys/sifanydataimage/image/*", "anon");
        filterMap.put("/sys/sifanyclass/*/*", "anon");
        filterMap.put("/sys/sifanydatatext/*/*", "anon");
        filterMap.put("/sys/sifanyclass/scenes/*", "anon");
        filterMap.put("/sys/sifanyclass/select/*", "anon");
        filterMap.put("/**", "authc");
